...
class MyDrawer extends StatelessWidget {
  ...
  Widget buildDrawerListItem(
    ...
    return ListTile(
      leading: Icon(
        leadingIcon,
        color: color ?? MyColors.paleGreen,
      ),
      title: Text(
        title,
      ...
      child: Row(
        children: [
          ...
          buildIcon(
            ...
            'https://www.linkedin.com/in/mahmoudzanoon/',
          ),
          const SizedBox(
            width: 20,
          ),
  ...
  Widget build(BuildContext context) {
    return Drawer(
      backgroundColor: MyColors.darkBcGrnd,
      child: ListView(
        ...
        children: [
          Container(
            height: 280,
            child: DrawerHeader(
              decoration: BoxDecoration(color: MyColors.paleGreen),
